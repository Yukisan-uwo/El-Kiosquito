...
- **RN-PM-008** *(añadida en enmienda v1.4, prohibición de precios en $0.00)*: Todo precio de venta registrado en el sistema (`precio_venta`), precio de competencia (`precio_referencia`) o recomendación de precio (`precio_recomendado`) DEBE ser estrictamente mayor a cero (`> 0.00`). No se permite registrar productos con precio $0.00 en el catálogo comercial para evitar transferencias de mercadería sin costo en el POS.
